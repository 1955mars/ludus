...
using questart::VulkanCommandPool;

namespace
{
    vk::UniqueCommandPool createCommandPool(const questart::VulkanDevice& device)
    {
...
struct VulkanCommandPool::Internal
{
    ...
    Internal(const questart::VulkanDevice& device)
        : commandPool(::createCommandPool(device)) {}
};

VulkanCommandPool::VulkanCommandPool(const questart::VulkanDevice& device)
    : internal(questart::make_internal_ptr<Internal>(device)) {}

vk::UniqueCommandBuffer VulkanCommandPool::beginCommandBuffer(const questart::VulkanDevice& device) const
{
