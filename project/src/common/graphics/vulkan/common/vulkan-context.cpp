...
struct VulkanContext::Internal
{
    ...
    Internal() 
               : instance(::createInstance()),
                 ...
                 device(questart::VulkanDevice(physicalDevice)),
                 commandPool(questart::VulkanCommandPool(device)),
                 renderContext(questart::VulkanRenderContext(*instance, physicalDevice, device, commandPool)),
...
/*
    void recreateRenderContext()
    {
        ...
        renderContext = renderContext.recreate(instance.get(), physicalDevice, device, commandPool);
...
{
    return internal->renderContext.getCurrentWindowSize();
}