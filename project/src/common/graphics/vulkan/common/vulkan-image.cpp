...
namespace
{
    ...
    vk::UniqueDeviceMemory allocateImageMemory(const questart::VulkanPhysicalDevice& physicalDevice,
...
struct VulkanImage::Internal
{
    ...
    Internal(const questart::VulkanCommandPool& commandPool,
        ...
        : width(width),
          ...
          mipLevels(mipLevels),
          format(format),
          image(::createImage(device.getDevice(), width, height, depth, mipLevels, layerCount, faceCount, sampleCount, format, tiling, usageFlags)),
...
VulkanImage::VulkanImage(const questart::VulkanCommandPool& commandPool,
                         const questart::VulkanPhysicalDevice& physicalDevice,
                         const questart::VulkanDevice& device,
                         const uint32_t& width,
                         const uint32_t& height,
                         ...
                         const vk::ImageLayout& oldLayout,
                         const vk::ImageLayout& newLayout)
    : internal(questart::make_internal_ptr<Internal>(commandPool,
                                                physicalDevice,
                                                device,
                                                width,
                                                height,
