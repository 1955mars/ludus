...
VulkanDevice::VulkanDevice(const questart::VulkanPhysicalDevice& physicalDevice, const questart::VulkanSurface& surface)
    : internal(questart::make_internal_ptr<Internal>(physicalDevice, surface)) {}
